  ...
  return (
    <div className="fixed bottom-4 z-50 right-4">
      ...
      <motion.form
        ...
        className={`${
          isOpen ? "block" : "hidden"
        } bg-[#050816] border rounded-md p-6 max-w-sm`}
      >
        <div
          onClick={() => setIsOpen(false)}
          className="flex justify-end mb-4 w-full cursor-pointer hover:opacity-75 duration-300"
        >
        ...
        >
          ...
          >
            <div className="flex items-center mb-2 gap-2">
              <Image
                ...
                height={32}
                alt="Me"
                className={`rounded-full cursor-pointer hover:opacity-75 duration-300`}
              />
              ...
              `}
                ...
                <span className="text-xs flex items-center">
                  ...
                  >
                    <path
                      fill="#059669"
                      d="M12 16a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"
                    />
                  </svg>
                  Online
                </span>
          ...
          {messages.map((m) => (
            <div
              key={m.id}
              className={`flex flex-col my-4 p-2 whitespace-normal overflow-wrap-break-word rounded-lg ${
                m.role === "assistant"
                  ? "self-start items-start bg-gray-800"
            ...
            <span className="relative">
              {
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path fill="#ffffff" d="M3 20v-6l8-2l-8-2V4l19 8z" />
                </svg>
              }
            </span>
          </button>
